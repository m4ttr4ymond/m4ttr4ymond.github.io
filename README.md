...
- `biorxiv`: Adds a link to the bioRxiv website (Note: only add the biorxiv identifier here - the link is generated automatically)
...
- `talk`: Adds a "Talk" button redirecting to a specified url.
